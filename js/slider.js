$(document).ready(function(){
    ...
    var multiItemSlider = (function () {
      return function (selector, config) {
        var
          ...
          _sliderWrapper = _mainElement.querySelector('.spehes__wrapper'), // обертка для .slider-item
          _sliderItems = _mainElement.querySelectorAll('.spehes__wrapper-listItem'), // элементы (.slider-item)
        ...
        var _transformItem = function (direction) {
          ...
          if (direction === 'right') {
            ...
            _positionLeftItem++;
            // var activeElement = $('.spehes__wrapper').children()[1];
    ...
    var slider = multiItemSlider('.spehes')
